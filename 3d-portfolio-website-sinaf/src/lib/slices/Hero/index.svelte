<script lang="ts">
	...
	import Scene from '$lib/slices/Hero/Scene.svelte';
	...
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<div class="col-start-1 md:row-start-1">
				<h1
					class="mb-2 md:mb-3 text-[clamp(3rem,17vmin,10rem)] font-extrabold leading-none tracking-tighter text-nowrap aria-label={slice.primary.first_name + ' ' + slice.primary.last_name}"
				>
					...
					{/if}
					{#if last_name_letters.length && last_name_letters.length}
				...
				<span
					class="tag-line block bg-gradient-to-tr from-yellow-500 via-yellow-200 to-yellow-500 bg-clip-text text-transparent text-2xl font-bold uppercase tracking-[.2em] md:text-4xl opacity-0"
				>
